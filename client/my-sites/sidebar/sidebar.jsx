...
export class MySitesSidebar extends Component {
	...
	trackStatsClick = () => {
		this.recordMenuItemClick( 'stats' );
		this.onNavigate();
	};
	...
	trackThemesClick = () => {
		this.recordMenuItemClick( 'themes' );
		this.onNavigate();
	};
	...
	trackSidebarButtonClick = name => {
		return () => {
			this.props.recordTracksEvent( 'calypso_mysites_sidebar_' + name + '_sidebar_button_clicked' );
		};
	};

	trackPluginsClick = () => {
		this.recordMenuItemClick( 'plugins' );
		this.onNavigate();
	};
	...
	trackDomainsClick = () => {
		this.recordMenuItemClick( 'domains' );
		this.onNavigate();
	};
	...
	trackStoreClick = () => {
		this.recordMenuItemClick( 'store' );
	...
	recordMenuItemClick = menuItemName => {
		this.props.recordTracksEvent( 'calypso_mysites_sidebar_' + menuItemName + '_clicked' );
	};

	trackPlanClick = () => {
		this.recordMenuItemClick( 'plan' );
	...
	trackSharingClick = () => {
		this.recordMenuItemClick( 'sharing' );
		this.onNavigate();
	};
	...
	trackPeopleClick = () => {
		this.recordMenuItemClick( 'people' );
		this.onNavigate();
	};
	...
	trackSettingsClick = () => {
		this.recordMenuItemClick( 'settings' );
		this.onNavigate();
	};
	...
	trackWpadminClick = () => {
		this.recordMenuItemClick( 'wpadmin' );
	...
	trackDomainSettingsClick = () => {
		this.recordMenuItemClick( 'domain_settings' );
		this.onNavigate();
	};
